<div id="wrapper">
    ...
    <div class="mobile-navbar">
        <nav class="navbar navbar-dark navbar-expand d-md-none d-lg-none d-xl-none fixed-bottom" style="height:75px; background-color: orangered;">
            <ul class="navbar-nav nav-justified w-100 justify-content-center">
                <li class="nav-item">
                    <a href="<?= base_url('home/comingsoon')?>" class="nav-link">
                ...
                <li class="nav-item">
                    <a href="/dashboardrt" class="nav-link"><svg width="1.5em" height="1.5em" viewBox="0 0 16 16" class="bi bi-house" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" d="M2 13.5V7h1v6.5a.5.5 0 0 0 .5.5h9a.5.5 0 0 0 .5-.5V7h1v6.5a1.5 1.5 0 0 1-1.5 1.5h-9A1.5 1.5 0 0 1 2 13.5zm11-11V6l-2-2V2.5a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5z" />
                            <path fill-rule="evenodd" d="M7.293 1.5a1 1 0 0 1 1.414 0l6.647 6.646a.5.5 0 0 1-.708.708L8 2.207 1.354 8.854a.5.5 0 1 1-.708-.708L7.293 1.5z" />
                        </svg><span class="small d-block">Home</span></a>
                </li>
                <li class="nav-item">
                    <a href="/dashboardrt/pengajuan_surat" class="nav-link"><svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" fill="currentColor" class="bi bi-journal-arrow-up" viewBox="0 0 16 16">
    ...
    <nav class="fixed-top align-top" id="sidebar-wrapper" role="navigation">
        <div class="simplebar-content" style="padding: 0px;">
            <a class="sidebar-brand" href="/dashboardrt">
            ...
            <ul class="navbar-nav align-self-stretch">
                ...
                <li class="">
                    <a class="nav-link text-left" role="button" aria-haspopup="true" aria-expanded="false" href="/dashboardrt" id="nav-item">
                        <i class="fas fa-columns"></i> Dashboard
                    </a>
                </li>
                <li class="">
                    <a class="nav-link text-left" role="button" aria-haspopup="true" aria-expanded="false" href="/dashboardrt/informasi_wilayah" id="nav-item">
                            ...
                            <div class="container-fluid ">
                                <div class="row">
                                    <div class="col-lg-12 px-2">
                                        <div class="submenu-box">
                                            <ul class="list-unstyled m-0">
                                                <li><a href="/dashboardrt/pengajuan_surat">Pengajuan Surat</a></li>
                            ...
                            <div class="container-fluid ">
                                <div class="row">
                                    <div class="col-lg-12 px-2">
                                        <div class="submenu-box">
                                            <ul class="list-unstyled m-0">
                                                <li><a href="/dashboardrt/data_warga">Data Warga</a></li>
                                                <li><a href="/dashboardrt/data_rt">Data RT</a></li>
