<div id="wrapper">
    ...
    <div class="mobile-navbar">
        <nav class="navbar navbar-dark navbar-expand d-md-none d-lg-none d-xl-none fixed-bottom" style="height:75px; background-color: orangered;">
            <ul class="navbar-nav nav-justified w-100 justify-content-center">
                <li class="nav-item">
                    <a href="/dashboardwarga/pengumuman" class="nav-link">
                ...
                <li class="nav-item">
                    <a href="/dashboardwarga" class="nav-link"><svg width="1.5em" height="1.5em" viewBox="0 0 16 16" class="bi bi-house" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    <nav class="fixed-top align-top" id="sidebar-wrapper" role="navigation">
        <div class="simplebar-content" style="padding: 0px;">
            <a class="sidebar-brand" href="/dashboardwarga">
            ...
            <ul class="navbar-nav align-self-stretch">
                ...
                <li class="">
                    <a class="nav-link text-left" role="button" aria-haspopup="true" aria-expanded="false" href="/dashboardwarga" id="nav-item">
                        <i class="fas fa-columns"></i> Dashboard
                    </a>
                </li>
                <li class="">
                    <a class="nav-link text-left" role="button" aria-haspopup="true" aria-expanded="false" href="/dashboardwarga/informasi_wilayah" id="nav-item">
                ...
                <li class="has-sub">
                    <a class="nav-link collapsed text-left" href="#warga" role="button" data-toggle="collapse" id="nav-item">
                        <i class="fas fa-cogs"></i> Pelayanan Warga
                    </a>
