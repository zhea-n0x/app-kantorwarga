                                ...
                                <tbody>
                                    ...
                                    ?>
                                            ...
                                            <tr class="text-center">
                                                <td><?= $row['id_rt']; ?></td> <td><?= $row['no_urut_rt']; ?></td>
                                                <td><?= $row['ketua_rt']; ?> </td>
                                                <td><?= $row['sekretaris_rt'] ?></td>
                                                <td><?= $row['bendahara_rt']; ?></td>
                                                <td>
                                                    <a href="/FlowdataRW/hapusRT/<?= $row['id_rt'] ?>" type="button" class="btn btn-danger"><i class="fas fa-trash"></i> Hapus</a>
                                                </td>
                                            </tr>
                                    <?php endforeach; ?>
                                </tbody>
